...
public class DataTransactionActivity extends Activity {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if(action.equals(BLEService.ACTION_GATT_CONNECTED)){
				...
				displayData(intent.getStringExtra(BLEService.EXTRA_DATA));
				 ...
				 Toast.makeText(DataTransactionActivity.this, "SERIAL_SERVICE_DISCOVERED", Toast.LENGTH_SHORT).show();
	             if (gattService == null) {
	                 Toast.makeText(DataTransactionActivity.this, "SERIAL_SERVICE_UNAVAILABLE", Toast.LENGTH_SHORT).show();
	                 return;
	              }
...
//		sendMessage(BLEService.EXTRA_DATA);
	...
	private void initViews(){
		...
		btn_back.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				mService.closeBLEService();
				Intent intent = new Intent(DataTransactionActivity.this,MainActivity.class);
	...
	private void sendMessage(String msg) {
        if ( isSerialReady && 
            ...
            Toast.makeText(DataTransactionActivity.this, "BLE Disconnected", Toast.LENGTH_SHORT).show();
        }
    }
