...
import service.SimpleUUIDAttributes;
...
public class BLEService extends Service {
    ...
    public final static String EXTRA_DATA =
            "ble.EXTRA_DATA";
    public final static UUID UUID_SOFT_SERIAL_SERVICE = UUID.fromString(SimpleUUIDAttributes.SOFT_SERIAL_SERVICE);
    public final static UUID UUID_MD_RX_TX = UUID.fromString(SimpleUUIDAttributes.MD_RX_TX);
    public final static UUID UUID_ETOH_RX_TX = UUID.fromString(SimpleUUIDAttributes.ETOH_RX_TX);
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
	   ...
	   if (UUID_MD_RX_TX.equals(characteristic.getUuid()) ||
           ...
           UUID.fromString(SimpleUUIDAttributes.CLIENT_CHARACTERISTIC_CONFIG));
